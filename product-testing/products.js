document.addEventListener("DOMContentLoaded", () => {
  const categoryData = {
    ...
    "adult-bedrooms-vanities": {
      ...
      heroImage: "../content/images_icons/hero-adult rooms.jpg",
      products: [
        { name: "JULIA Vanity", price: "$750.00", modelUrl: "../content/products/vanity_julia2.glb", cameraOrbit: "30deg 85deg 4m", description: "The Julia vanity is a statement of elegance and refined craftsmanship, designed to bring luxury and functionality to your bedroom. Crafted from beige travertine MDF, it showcases a sleek design accentuated by champagne-colored aluminum details and stained glass elements for a sophisticated touch." },
    ...
    "kids-bedrooms-desks": {
      ...
      products: [
        ...
        { name: "LARA Blue Desk", price: "$549.99", modelUrl: "../content/products/desk_lara_blue.glb", cameraOrbit: "30deg 85deg 4m", description: "The Lara Blue desk is a serene and functional piece, designed to perfectly complement the peaceful atmosphere of the Lara Blue children's room. Featuring a soft white base with subtle blue accents, this desk creates an inspiring space for your little one to study, create, or play." },
        { name: "DOMINO Desk", price: "$650.00", modelUrl: "../content/products/desk_domino.glb", cameraOrbit: "30deg 85deg 4m", description: "The Domino desk is a unique and functional addition to the Domino kids' room, blending playful design with practicality. Crafted in a harmonious mix of green, beige, and natural wood tones, it creates a warm and inviting space for your child to study, create, or organize." },
      ],
    },
